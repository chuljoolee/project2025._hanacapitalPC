...
import IconvoiceFishing from '@/assets/images/icon/voice-fishing.svg'; //241014
  ...
  <PageContents size="wide">
    ...
    <section :class="$style['customer-layout__section']">
      ...
      <div :class="$style['icon-list']">
        <ul :class="[$style['icon-list__list__flex']]">
          <!--//241014 , 'flex-wrap'-->
              ...
              <div :class="$style['icon-list__content']">
                ...
                >
                  <ul :class="[$style['customer-links__list'], 'flex-column']">
                    ...
                    <li :class="$style['customer-links__item']">
                      <a
                        href="https://www.fss.or.kr/fss/job/fvsttPrcdnt/list.do?menuNo=200179"
                        class="router-link-active router-link-exact-active _button_863j1_1 _button--block_863j1_65 _button--icon-medium_863j1_73 _button--text-medium_863j1_86 color-gray-tertiary"
                        target="_blank"
                        ><span class="_button__text_863j1_39">
                          금융분쟁판례 </span
                        ><span class="_button__icon_863j1_42"
                          ><svg
                            data-v-41f508d5=""
                          ...
                          >
                            <path
                              fill="#8F8F8F"
                              d="M8.293 3.793a1 1 0 0 0 0 1.414l6.293 6.293-6.293 6.293a1 1 0 1 0 1.414 1.414l7-7a1 1 0 0 0 0-1.414l-7-7a1 1 0 0 0-1.414 0Z"
                            ></path></svg></span
                      ></a>
                    </li>
                    <li :class="$style['customer-links__item']">
                      <a
                        href="https://www.fss.or.kr/fss/job/fncCnflCase/list.do?menuNo=200516"
                        class="router-link-active router-link-exact-active _button_863j1_1 _button--block_863j1_65 _button--icon-medium_863j1_73 _button--text-medium_863j1_86 color-gray-tertiary"
                        target="_blank"
                        ><span class="_button__text_863j1_39">
                          분쟁조정사례 </span
                    ...
                    <li :class="$style['customer-links__item']">
                      <a
                        href="https://gongsi.crefia.or.kr/portal/dispute/disputeCurrentStateDetail1?udgcMode=1"
                        class="router-link-active router-link-exact-active _button_863j1_1 _button--block_863j1_65 _button--icon-medium_863j1_73 _button--text-medium_863j1_86 color-gray-tertiary"
                        target="_blank"
                        ><span class="_button__text_863j1_39">
                          분쟁중 소제기 현황 </span
                    ...
                    <li :class="$style['customer-links__item']">
                      <a
                        href="https://gongsi.crefia.or.kr/portal/creditcard/creditcardDisclosureDetail27?cgcMode=27"
                        class="router-link-active router-link-exact-active _button_863j1_1 _button--block_863j1_65 _button--icon-medium_863j1_73 _button--text-medium_863j1_86 color-gray-tertiary"
                        target="_blank"
                        ><span class="_button__text_863j1_39">
                          금융소비자보호실태평가 </span
              ...
              <div :class="$style['icon-list__content']">
                ...
                >
                  <ul :class="[$style['customer-links__list'], 'flex-column']">
                    <li :class="$style['customer-links__item']">
                      <a
                        href="https://www.fss.or.kr/fss/main/sub1voice.do?menuNo=200012"
                        class="router-link-active router-link-exact-active _button_863j1_1 _button--block_863j1_65 _button--icon-medium_863j1_73 _button--text-medium_863j1_86 color-gray-tertiary"
                        target="_blank"
                        ><span class="_button__text_863j1_39">
                          보이스피싱 지킴이 </span
